...
The active trading runtime is Solana-based and uses PostgreSQL. The older Binance/MongoDB pipeline under `src/data/` is retained for legacy research only. See [ACTIVE_ARCHITECTURE.md](ACTIVE_ARCHITECTURE.md) before adding data or visualization features.
